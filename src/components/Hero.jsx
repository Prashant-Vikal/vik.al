  ...
  return (
    <section className="wrap hero">
      <div className="hero-text">
        <h1 className="load">X I lead design as a core business function.</h1>
        {/* <h1 className="load">I design the systems by which design gets done.</h1> */}
        <p className="sub load">I develop autonomous teams and architect the AI-native infrastructure they need to ship predictably across every customer touchpoint. True design leadership isn't about micromanaging the screen. It is about taking absolute accountability for the end-to-end product ecosystem and governing the engine behind it.</p>
